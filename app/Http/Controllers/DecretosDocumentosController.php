...
use App\Models\DecretosDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class DecretosDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = DecretosDocumentos::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = DecretosDocumentos::find($request->id);
