...
use App\Models\sistemaCalidadPdfConsulta;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SistemaCalidadPdfConsultaController extends Controller
{
    public function bannerData()
    {
        $datosBanner = sistemaCalidadPdfConsulta::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new sistemaCalidadPdfConsulta();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = sistemaCalidadPdfConsulta::find($request->id);
