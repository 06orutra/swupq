...
use App\Models\chatWelcome;
use Illuminate\Http\Request;

class ChatWelcomeController extends Controller
{
    public function bannerData(){
        $datosTexto = chatWelcome::all();
    ...
    public function editarBanner(Request $request){
        ...
        $texto = chatWelcome::find($request->id);
