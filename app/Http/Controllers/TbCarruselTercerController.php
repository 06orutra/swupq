...
use App\Models\tb_carrusel_tercer;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class TbCarruselTercerController extends Controller
{
    public function bannerData()
    {
        $datosBanner = tb_carrusel_tercer::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = tb_carrusel_tercer::find($request->id);
