...
use App\Models\lenguaExtra_imgSecundario;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LenguaExtraImgSecundarioController extends Controller
{
    public function bannerData()
    {
        $datosBanner = lenguaExtra_imgSecundario::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new lenguaExtra_imgSecundario;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =lenguaExtra_imgSecundario::find($request->id);
