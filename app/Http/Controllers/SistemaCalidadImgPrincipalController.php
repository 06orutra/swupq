...
use App\Models\sistemaCalidadImgPrincipal;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SistemaCalidadImgPrincipalController extends Controller
{
    public function bannerData()
    {
        $datosBanner = sistemaCalidadImgPrincipal::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new sistemaCalidadImgPrincipal;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =sistemaCalidadImgPrincipal::find($request->id);
