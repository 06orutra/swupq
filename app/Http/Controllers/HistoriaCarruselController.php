...
use App\Models\historia_carrusel;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class HistoriaCarruselController extends Controller
{
    public function bannerData()
    {
        $datosBanner = historia_carrusel::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =historia_carrusel::find($request->id);
