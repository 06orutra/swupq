...
use App\Models\BannerMascotas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class BannerMascotasController extends Controller
{
    public function bannerData()
    {
        $datosBanner = BannerMascotas::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =BannerMascotas::find($request->id);
