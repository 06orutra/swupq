...
use App\Models\igualdadLaboralPdfEtica;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class IgualdadLaboralPdfEticaController extends Controller
{
    public function bannerData()
    {
        $datosBanner = igualdadLaboralPdfEtica::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new igualdadLaboralPdfEtica();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = igualdadLaboralPdfEtica::find($request->id);
