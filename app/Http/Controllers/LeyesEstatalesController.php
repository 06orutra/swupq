...
use App\Models\LeyesEstatales;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LeyesEstatalesController extends Controller
{
    public function bannerData()
    {
        $datosBanner = LeyesEstatales::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = LeyesEstatales::find($request->id);
