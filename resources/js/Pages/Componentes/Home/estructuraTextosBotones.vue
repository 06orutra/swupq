...
export default {
    ...
    methods: {
        ...
        registrarTexto() {
            ...
            if (this.titulo == null || this.contenido == null || this.identificador == null) {
        ...
        editarTexto() {
            this.submitted = true;
            //validar si hay campos vacios
            if (this.datosArreglo.titulo == null || this.datosArreglo.contenido == null || this.datosArreglo.identificador == null) {
                // si alguno de los campos esta vacio, no enviar el formulario y mostrar un mensaje de error
                this.$toast.add({
                    severity: "error",
                    summary: "Error",
            ...
            formData.append('identificador', this.datosArreglo.identificador);
    ...
    data() {
        return {
            ...
            titulo: null,
            contenido: null,
            identificador: null, // Agrega esta línea para el identificador
            searchQuery: '',
...
<template>
    ...
    <div class="cards-container">
        <Card v-for="datosTexto in filteredBanner" style="width: 40em; margin-bottom: 40px;">
            ...
            <template #subtitle> Contenido: {{ datosTexto.contenido }}
            <br>Identificador: {{ datosTexto.identificador }} </template>
        ...
        <div class="field">
            <form @submit.prevent="registrarTexto">
                ...
                <div class="field col-12 md:col-12">
                    ...
                    <InputText inputId="minmax" v-model="identificador" />
                </div>
    ...
    <Dialog v-model:visible="editarDialog" :breakpoits="{ '960px': '75vw', '640px': '85vw' }" :style="{ width: '25vw' }"
        ...
        <div class="field">
            <form @submit.prevent="editarTexto">
                ...
                <div class="field col-12 md:col-12">
                    <label for="minmax"> Identificador </label>
                    <Textarea inputId="minmax" v-model="datosArreglo.identificador" :min="0" :max="10000" :showButtons="true" />
                </div>
