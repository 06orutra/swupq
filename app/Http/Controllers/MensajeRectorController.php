...
use App\Models\mensaje_rector;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class MensajeRectorController extends Controller
{
    public function bannerData()
    {
        $datosBanner = mensaje_rector::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = mensaje_rector::find($request->id);
