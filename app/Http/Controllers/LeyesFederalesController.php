...
use App\Models\LeyesFederales;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LeyesFederalesController extends Controller
{
    public function bannerData()
    {
        $datosBanner = LeyesFederales::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = LeyesFederales::find($request->id);
