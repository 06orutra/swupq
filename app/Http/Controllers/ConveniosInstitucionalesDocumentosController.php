...
use App\Models\ConveniosInstitucionalesDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class ConveniosInstitucionalesDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = ConveniosInstitucionalesDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new ConveniosInstitucionalesDocumentos();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = ConveniosInstitucionalesDocumentos::find($request->id);
