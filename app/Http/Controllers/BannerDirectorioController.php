...
use App\Models\BannerDirectorio;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;


class BannerDirectorioController extends Controller
{
    public function bannerData()
    {
        $datosBanner = BannerDirectorio::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =BannerDirectorio::find($request->id);
