...
use App\Models\sistemaCalidadImgSecundaria;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SistemaCalidadImgSecundariaController extends Controller
{
    public function bannerData()
    {
        $datosBanner = sistemaCalidadImgSecundaria::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new sistemaCalidadImgSecundaria;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =sistemaCalidadImgSecundaria::find($request->id);
