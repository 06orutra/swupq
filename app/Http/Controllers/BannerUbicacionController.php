...
use App\Models\BannerUbicacion;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class BannerUbicacionController extends Controller
{
    public function bannerData()
    {
        $datosBanner = BannerUbicacion::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =BannerUbicacion::find($request->id);
