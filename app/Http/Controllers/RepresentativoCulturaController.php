...
use App\Models\representativo_cultura;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class RepresentativoCulturaController extends Controller
{
    public function bannerData()
    {
        $datosBanner = representativo_cultura::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new representativo_cultura;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =representativo_cultura::find($request->id);
