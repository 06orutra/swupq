...
<template>
    <TabView ref="tabview1" class="p-3">
        <TabPanel header="Carrusel Principal">
            <estructuraImg :loadDataUrl="'/representativoPrin/bannerData'" :registerBannerUrl="'/representativoPrin/registrarBanner'"
                :editBannerUrl="'/representativoPrin/editarBanner'" :deleteBannerUrl="'/representativoPrin/eliminarBanner'" />
        </TabPanel>
