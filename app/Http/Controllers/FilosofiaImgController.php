...
use App\Models\filosofia_img;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class FilosofiaImgController extends Controller
{
    public function bannerData()
    {
        $datosBanner = filosofia_img::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =filosofia_img::find($request->id);
