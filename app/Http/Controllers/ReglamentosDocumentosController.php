...
use App\Models\ReglamentosDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class ReglamentosDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = ReglamentosDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new ReglamentosDocumentos();
