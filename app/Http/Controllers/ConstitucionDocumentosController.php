...
use App\Models\ConstitucionDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class ConstitucionDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = ConstitucionDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new ConstitucionDocumentos();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = ConstitucionDocumentos::find($request->id);
