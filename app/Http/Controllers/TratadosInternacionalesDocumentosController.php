...
use App\Models\TratadosInternacionalesDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class TratadosInternacionalesDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = TratadosInternacionalesDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new TratadosInternacionalesDocumentos();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = TratadosInternacionalesDocumentos::find($request->id);
