...
use App\Models\rectorBanner;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class RectorBannerController extends Controller
{
    public function bannerData()
    {
        $datosBanner = rectorBanner::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =rectorBanner::find($request->id);
