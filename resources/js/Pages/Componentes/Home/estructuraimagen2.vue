<template>
    <div>
      ...
      <div class="circle-radio-group">
        <div class="circle-radio" :class="{ selected: Poli_o_Polo === '0' }" @click="Poli_o_Polo = '0'"></div>
        <span class="radio-label">Poli</span>
        <div class="circle-radio" :class="{ selected: Poli_o_Polo === '1' }" @click="Poli_o_Polo = '1'"></div>
        <span class="radio-label">Polo</span>
      </div>
    </div>
      ...
      <Dialog v-model:visible="editarDialog" :breakpoits="{ '960px': '75vw', '640px': '85vw' }" :style="{ width: '25vw' }"
        ...
        <div class="field">
          <form @submit.prevent="editarBanner">
            ...
            <div class="field col-12 md-3">
              <label for="poli_o_polo">Poli_o_Polo</label>
              <input type="checkbox" v-model="datosArreglo.Poli_o_Polo" id="poli_o_polo" />
            </div>
      ...
      <Dialog v-model:visible="eliminarDialog" :style="{ width: '450px' }" header="Confirmar Eliminar" :modal="true">
        ...
        <template #footer>
          ...
          <Button label="Sí" icon="pi pi-check" class="p-button-text" @click="eliminarBanner" />
        </template>
      </Dialog>
    </div>
  </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        photoInput: null,
        imagePreview: null,
        Poli_o_Polo: null, // Agrega el campo booleano
      };
    },
    methods: {
        cargarBanner() {
      ...
      registrarBanner() {
        ...
        formData.append('Poli_o_Polo', this.Poli_o_Polo); // Incluye el campo booleano
      ...
      editarBanner() {
        ...
        formData.append('Poli_o_Polo', this.datosArreglo.Poli_o_Polo);
...
.circle-radio-group {
  display: flex;
  align-items: center;
  gap: 10px; /* Agrega un margen entre las opciones y los círculos */
}
...
.radio-label {
  font-size: 14px;
  /* ... Otros estilos de las etiquetas ... */
}
