...
use App\Models\BannerMarcoJuridico;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class BannerMarcoJuridicoController extends Controller
{
    public function bannerData()
    {
        $datosBanner = BannerMarcoJuridico::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new BannerMarcoJuridico;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =BannerMarcoJuridico::find($request->id);
