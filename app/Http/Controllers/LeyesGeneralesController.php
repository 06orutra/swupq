...
use App\Models\LeyesGenerales;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LeyesGeneralesController extends Controller
{
    public function bannerData()
    {
        $datosBanner = LeyesGenerales::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = LeyesGenerales::find($request->id);
