...
use App\Models\representativo_prin;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class RepresentativoPrinController extends Controller
{
    public function bannerData()
    {
        $datosBanner = representativo_prin::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new representativo_prin;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =representativo_prin::find($request->id);
