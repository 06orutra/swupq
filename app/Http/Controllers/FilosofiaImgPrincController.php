...
use App\Models\filosofia_imgPrinc;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class FilosofiaImgPrincController extends Controller
{
    public function bannerData()
    {
        $datosBanner = filosofia_imgPrinc::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = filosofia_imgPrinc::find($request->id);
