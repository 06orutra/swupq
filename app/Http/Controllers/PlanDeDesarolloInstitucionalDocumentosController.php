...
use App\Models\PlanDeDesarolloInstitucionalDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class PlanDeDesarolloInstitucionalDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = PlanDeDesarolloInstitucionalDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new PlanDeDesarolloInstitucionalDocumentos();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = PlanDeDesarolloInstitucionalDocumentos::find($request->id);
