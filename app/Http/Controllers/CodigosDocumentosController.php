...
use App\Models\CodigosDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class CodigosDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = CodigosDocumentos::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = CodigosDocumentos::find($request->id);
