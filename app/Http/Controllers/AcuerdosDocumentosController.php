...
use App\Models\AcuerdosDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class AcuerdosDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = AcuerdosDocumentos::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = AcuerdosDocumentos::find($request->id);
