...
use App\Models\representativo_deporte;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class RepresentativoDeporteController extends Controller
{
    public function bannerData()
    {
        $datosBanner = representativo_deporte::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new representativo_deporte;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =representativo_deporte::find($request->id);
