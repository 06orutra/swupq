...
use App\Models\educationalBanners;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class EducationalBannersController extends Controller
{
    public function bannerData()
    {
        $datosBanner = educationalBanners::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =educationalBanners::find($request->id);
