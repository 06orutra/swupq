...
<template>
    <TabView ref="tabview1" class="p-3">
        ...
        <TabPanel header="Tratados Internaciones" >
            <hr class="blue-divider">
            <p>
                <span style="color: #007bff; font-weight: bold;">Documentos</span>
            </p>
        ...
        <TabPanel header="Convenios Institucionales" >
            <hr class="blue-divider">
            <p>
                <span style="color: #007bff; font-weight: bold;">Documentos</span>
            </p>
