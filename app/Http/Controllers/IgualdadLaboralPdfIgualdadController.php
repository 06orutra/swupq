...
use App\Models\igualdadLaboralPdfIgualdad;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class IgualdadLaboralPdfIgualdadController extends Controller
{
    public function bannerData()
    {
        $datosBanner = igualdadLaboralPdfIgualdad::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new igualdadLaboralPdfIgualdad();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = igualdadLaboralPdfIgualdad::find($request->id);
