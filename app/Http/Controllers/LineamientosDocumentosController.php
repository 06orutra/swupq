...
use App\Models\LineamientosDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LineamientosDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = LineamientosDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new LineamientosDocumentos();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = LineamientosDocumentos::find($request->id);
