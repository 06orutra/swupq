...
use App\Models\igualdadLaboralPdf;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class IgualdadLaboralPdfController extends Controller
{
    public function bannerData()
    {
        $datosBanner = igualdadLaboralPdf::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = igualdadLaboralPdf::find($request->id);
