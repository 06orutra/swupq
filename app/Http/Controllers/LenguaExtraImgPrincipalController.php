...
use App\Models\lenguaExtra_imgPrincipal;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LenguaExtraImgPrincipalController extends Controller
{
    public function bannerData()
    {
        $datosBanner = lenguaExtra_imgPrincipal::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new lenguaExtra_imgPrincipal;
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner =lenguaExtra_imgPrincipal::find($request->id);
