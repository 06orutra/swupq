...
use App\Models\historia_imgPrinc;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class HistoriaImgPrincController extends Controller
{
    public function bannerData()
    {
        $datosBanner = historia_imgPrinc::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = historia_imgPrinc::find($request->id);
