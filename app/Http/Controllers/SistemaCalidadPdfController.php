...
use App\Models\sistemaCalidadPdf;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SistemaCalidadPdfController extends Controller
{
    public function bannerData()
    {
        $datosBanner = sistemaCalidadPdf::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = sistemaCalidadPdf::find($request->id);
