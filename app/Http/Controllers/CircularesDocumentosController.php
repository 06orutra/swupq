...
use App\Models\CircularesDocumentos;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class CircularesDocumentosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = CircularesDocumentos::all();
    ...
    public function registrarBanner(Request $request)
    {
        ...
        $banner = new CircularesDocumentos();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = CircularesDocumentos::find($request->id);
